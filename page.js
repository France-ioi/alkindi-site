...
myApp.config(function($routeProvider) {
   ...
   .when('/', {
      templateUrl : 'pageMain.html?v=15',
      controller  : 'PageCtrl'
   })

   // route for the dicovery page
   .when('/pageDiscover', {
      templateUrl : 'pageDiscover.html?v=15',
      controller  : 'PageCtrl'
   })

   // route for the manual page
   .when('/pageManual', {
      templateUrl : 'pageManual.html?v=15',
      controller  : 'PageCtrl'
   })
   ...
   .when('/pageBD', {
      templateUrl : 'pageBD.html?v=15',
      controller  : 'PageCtrl'
   });
});

myApp.controller('PageCtrl', function() {
    $("#monActu").load("actu.html?v=15"); 
   });
